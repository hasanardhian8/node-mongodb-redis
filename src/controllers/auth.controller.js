...
export default {
  validate: {
    register: [body("firstName", "firstName doesnt exists").exists().isLength({ min: 2 }).withMessage("min 2 char"), body("email", "Invalid email").exists().isEmail(), body("password").exists().isLength({ min: 6 })],
