...
import { Content, Role } from "../models/index.js";
import Response from "../helpers/response.helper.js";
import mongo from "../helpers/moongose.helper.js";

export default {
  validate: {
    create: [body("firstName", "firstName doesnt exists").exists().isLength({ min: 2 }).withMessage("min 2 char"), body("email", "Invalid email").exists().isEmail(), body("password").exists().isLength({ min: 6 })],
